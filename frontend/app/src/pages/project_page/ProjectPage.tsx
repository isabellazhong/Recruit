...
import { ResumeUpload } from '../../components/project_page/ProjectPage';
import TechnicalPractice from '../../components/project_page/TechnicalPractice';
import type { ResumeData } from '../../components/project_page/ProjectPage';
...
export default function ProjectPage({ onBack, jobDescription, setJobDescription }: ProjectPageProps) {
